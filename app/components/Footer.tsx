    ...
    <footer className="bg-[var(--bg-deep)] border-t border-[var(--border)] pt-16 pb-12 text-[var(--text-lo)] text-xs">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="font-display font-extrabold text-xl tracking-tight flex items-center leading-none">
                  <span className="text-[var(--text-hi)]">Omni</span>
                  <span className="text-[#f5a623]">bites</span>
                </span>
                <span className="font-mono text-[10px] tracking-wider uppercase text-[var(--text-faint)] mt-0.5 font-medium">
                  Restaurant
                </span>
              </div>
            </Link>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left text-xs font-mono text-[var(--text-faint)]">
          <div>
            &copy; {new Date().getFullYear()} <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> Technologies Inc. All rights reserved.
          </div>
