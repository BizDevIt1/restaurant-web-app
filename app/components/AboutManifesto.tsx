...
export default function AboutManifesto() {
  ...
  return (
    <section id="mission" ref={sectionRef} className="py-14 md:py-16 relative scroll-mt-24 border-b border-[var(--border)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[var(--text-hi)] leading-tight">
              Software Built for <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">Modern Food Service Operators</span>
            </h2>
            ...
            <div className="space-y-4 text-[var(--text-lo)] text-sm sm:text-base leading-relaxed">
              ...
              <p>
                <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> was engineered from the ground up to bridge this gap. We built native JazzCash and Easypaisa QR workflows, dual Urdu/English thermal receipt formatting, and offline-first till architecture that survives local connectivity drops without missing a beat.
              </p>
              <p>
                From an independent street food kitchen in Gujranwala or Rawalpindi to a 10-outlet franchise spanning Lahore and Karachi, <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> provides the modern digital operating system Pakistani food entrepreneurs deserve.
              </p>
            </div>
