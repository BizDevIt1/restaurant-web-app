...
export default function ProductShowcase() {
  ...
  return (
    <section id="product" className="py-14 md:py-16 relative bg-[var(--bg-deep)]/60 border-b border-[var(--border)]">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[var(--text-hi)]">
            Explore the <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">Operating System</span>
          </h2>
          <p className="text-[var(--text-lo)] text-base sm:text-lg">
            Switch between modules below to see how seamlessly <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> handles frontline billing, kitchen tickets, online marketplace, and backend financial control.
          </p>
        </div>
          ...
          <div className="inline-flex items-center p-1.5 rounded-full bg-[var(--surface-hi)] border border-[var(--border)] backdrop-blur-md gap-1">
            {tabs.map((tab, idx) => (
              <button
                ...
                className={`px-4 sm:px-5 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 whitespace-nowrap cursor-pointer ${activeTab === idx
