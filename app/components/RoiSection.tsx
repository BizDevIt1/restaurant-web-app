...
export default function RoiSection() {
  ...
  return (
    <section ref={sectionRef} className="py-14 md:py-16 relative border-b border-[var(--border)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[var(--text-hi)]">
                Tangible Business Impact on <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">Day One</span>
              </h2>

              <p className="text-[var(--text-lo)] text-sm sm:text-base leading-relaxed">
                <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> doesn&apos;t just record receipts — it removes friction from your entire food production pipeline, unlocking higher profit margins per seat and delivery order.
              </p>
