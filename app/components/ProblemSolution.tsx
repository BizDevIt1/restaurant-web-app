...
export default function ProblemSolution() {
  ...
  return (
    <section className="py-14 md:py-16 relative overflow-hidden border-b border-[var(--border)]">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[var(--text-hi)]">
            Stop Running Your Restaurant on <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">Fragmented Tools</span>
          </h2>
          <p className="text-[var(--text-lo)] text-base sm:text-lg">
            See how <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> replaces chaotic paper slips and messaging-app confusion with unified, automated digital precision.
          </p>
        </motion.div>
            ...
            <div className="flex items-center justify-between pb-6 mb-6 border-b border-[var(--rust)]/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--text-lo)]">Without <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span></p>
                </div>
              </div>
          ...
          >
            <div className="flex items-center justify-between pb-6 mb-6 border-b border-[var(--olive)]/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-display font-bold text-xl text-[var(--text-hi)]">
                    How <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> Fixes It
                  </h3>
                  <p className="text-xs text-[var(--olive)] font-medium">With <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span></p>
                </div>
              </div>
