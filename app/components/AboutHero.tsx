...
export default function AboutHero() {
  return (
    <section className="relative pt-28 pb-10 md:pt-32 md:pb-14 text-center border-b border-[var(--border)]">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto space-y-5">
          ...
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[var(--gold-dim)] border border-[var(--gold)]/30 text-[var(--gold)] text-xs font-semibold uppercase tracking-wider">
            ...
            About <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span>
          </div>
          ...
          <h1 className="font-display font-extrabold text-3xl sm:text-5xl lg:text-[3.25rem] text-[var(--text-hi)] leading-[1.15] tracking-tight">
            Powering Multi-Vendor Restaurants, <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">From Kitchen to Delivery</span>
          </h1>
