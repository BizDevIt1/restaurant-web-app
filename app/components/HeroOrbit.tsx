...
export default function HeroOrbit() {
  ...
  return (
    <section className="relative pt-28 pb-10 md:pt-32 md:pb-14 overflow-hidden border-b border-[var(--border)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 space-y-7 text-left z-10">
            ...
            <p className="text-base sm:text-lg text-[var(--text-lo)] max-w-xl leading-relaxed">
              Replace disconnected WhatsApp ordering, manual paper slips, and scattered spreadsheets. <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> unites your billing till, kitchen display, inventory, local payment methods, and direct delivery marketplace into one unified operating system — wherever your restaurant operates.
            </p>
