...
export default function FaqAccordion() {
  ...
  return (
    <section id="faq-teaser" className="py-14 md:py-16 relative bg-[var(--bg-deep)]/50 border-b border-[var(--border)]">
      <div className="max-w-[960px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12 space-y-3">
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[var(--text-hi)]">
            Got Questions? We Have <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">Answers</span>
          </h2>
          <p className="text-[var(--text-lo)] text-base max-w-2xl mx-auto">
            Everything you need to know about adopting <span className="font-semibold"><span className="text-[#f7f0dd]">Omni</span><span className="text-[#f5a623]">bites</span></span> in your restaurant operations.
          </p>
        </div>
          ...
          <div className="divide-y divide-[var(--border)]/40">
            {teaserFaqs.map((faq, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`py-5 sm:py-6 transition-all duration-300 ${isOpen ? "opacity-100" : "opacity-90 hover:opacity-100"
                    }`}
                >
                  <button
                  ...
                  >
                    ...
                    <div
                      className={`w-7 h-7 rounded-full border border-[var(--border)] flex items-center justify-center shrink-0 transition-all duration-300 ${isOpen
                  ...
                  <div
                    className={`transition-all duration-300 ease-in-out pl-11 pr-2 overflow-hidden ${isOpen ? "max-h-96 pt-3.5 opacity-100" : "max-h-0 pt-0 opacity-0"
                      }`}
                  >
