...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-14 md:py-16 relative bg-[var(--bg-deep)]/40 border-b border-[var(--border)]">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-[var(--text-hi)]">
            Up and Running in <span className="bg-gradient-to-r from-[#fcebc0] via-[#e3b13b] to-[#e04e17] bg-clip-text text-transparent">Five Simple Steps</span>
          </h2>
